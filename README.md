...
* String Immutability ([Repo](https://github.com/fw-43/string-immutability)) — A little experiment to showcase String immutability in Java environment.
...
* Supply Chain Service ([Repo](https://github.com/fw-43/supply-chain-service)) — (Full-stack) A supply chain application using Java Spring Boot and React, featuring real-time dashboard analytics, automated order simulation, and granular role-based access control.
* ...
* ...
* ...
* ...
